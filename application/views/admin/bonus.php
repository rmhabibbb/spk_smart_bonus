        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12   col-sm-12  col-md-12   col-lg-12 ">
                <ol class="breadcrumb breadcrumb-bg-brown align-left">
                    ...
                    <li> <i class="material-icons">card_giftcard</i> Bonus Tahunan </li> 
                </ol>
                <div class="card">
                      <div class="header">
                            <center><h2>DATA BONUS TAHUNAN</h2></center>                          
                        </div>
                        <div class="body">
                        
                        <a   data-toggle="modal" data-target="#tambah"  href=""><button class="btn bg-brown">Buat Bonus Tahunan</button></a> 
                        <br><br>
                                          ...
                                          <tr>   
                                              ...
                                              ?></td>    
                                               ...
                                               <td style="vertical-align: middle;">
                                                  ...
                                                  <a href="<?=base_url('admin/bonus/'.$row->id_bonus)?>"><button class="btn bg-brown">Lihat Detail</button></a>

        ...
        <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ol class="breadcrumb breadcrumb-bg-brown align-left">
                        ...
                        <li> <a href="<?=base_url('admin/kriteriajobdesk')?>"><i class="material-icons">business_center</i> Kelola Data Kriteria Jobdesk</a> </li>  
                                          ...
                                          <tr>   
                                              ...
                                              <td><?=$row->nilai?></td>   
                                               ...
                                               <td style="vertical-align: middle;"> 
                                                  ...
                                                  <a data-toggle="modal" data-target="#edit-<?=$row->id_sub_jobdesk?>"  href=""><button class="btn bg-brown">Edit</button></a>
                                                  

                                                  <a data-toggle="modal" data-target="#delete-<?=$row->id_sub_jobdesk?>"  href=""><button class="btn bg-red">Hapus</button></a>
                                               </td>             
                                          </tr>
                                      <?php endforeach; ?>
                                    </tbody>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?= base_url('admin/kriteriajobdesk')?>" method="Post"  >   
                          <input type="hidden" class="foarm-control" name="id_kriteria_jobdesk"   required  value="<?=$kriteria->id_kriteria_jobdesk?>" >   
                          ...
                          <tr>   
                              ...
                              <th>
                                  <select class="form-control" name="kd_divisi" required>
                                                     <option value="<?=$kriteria->kd_divisi?>"><?=$this->Divisi_m->get_row(['kd_divisi' => $kriteria->kd_divisi])->nama_divisi ?></option>
                                                     <?php foreach ($list_divisi as $d) {
                                                        if ($d->kd_divisi != $kriteria->kd_divisi) { 
                                                      ?>
...
<div class="modal fade" id="tambahsub" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('admin/detailkriteriajobdesk')?>" method="Post"  >  
                            
                            <input type="hidden" name="id_kriteria_jobdesk" value="<?=$kriteria->id_kriteria_jobdesk?>"> 
...
<?php $i = 1; foreach ($list_detail as $row): ?> 
  <div class="modal fade" id="edit-<?=$row->id_sub_jobdesk?>" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header"> 
                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('admin/detailkriteriajobdesk')?>" method="Post"  > 
                            ...
                            <input type="hidden" value="<?=$kriteria->id_kriteria_jobdesk?>" name="id_kriteria_jobdesk">  
                            <input type="hidden" value="<?=$row->id_sub_jobdesk?>" name="id_sub_jobdesk">   
...
<?php $i = 1; foreach ($list_detail as $row): ?> 
 <div class="modal fade" id="delete-<?=$row->id_sub_jobdesk?>" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header"> 

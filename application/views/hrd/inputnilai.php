                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body"> 
                            <table class="table table-bordered table-striped table-hover" style="max-height: 300px">
                                ...
                                <tbody>
                                     ...
                                     <tr>
                                          ...
                                          <td>
                                            <a href="<?=base_url('hrd/penilaian/hasildivisi/'.$bonus->id_bonus)?>">Lihat Hasil</a>
                                          </td>
                                        </tr>
                                     <tr>
                                         <th style="width: 30%">
                            ...
                            <center>
                               <a data-toggle="modal" data-target="#selesai"  href=""><button class="btn bg-green">Penilaian Selesai</button></a>
                            </center>
                                 ...
                                 <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                      ...
                                      foreach ($list_karyawan as $row): ?> 
                                        <?php if ($this->PenilaianHRD_m->get_num_row(['nip' => $row->nip,'id_bonus' => $bonus->id_bonus]) != 0) { ?>
                                          <tr>    
                                              <td><?=$row->nip?></td>  
                                              <td><?=$row->nama?></td>  
                                              <?php  foreach ($list_kriteria as $k): ?> 
                                                <td> 
                                                  <?=$this->PenilaianHRD_m->get_row(['nip' => $row->nip, 'id_bonus' => $bonus->id_bonus,'id_kriteria_umum' => $k->id_kriteria_umum])->nilai?>
                                                </td>  
                                              <?php endforeach; ?>
                        ...
                        <div class="modal-body">
                         <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <form action="<?= base_url('hrd/penilaian')?>" method="Post" > 
                            ...
                            <table class="table table-bordered">
                              <tr>
                                ...
                                <td>
                                  <select class="form-control" name="nip" required>
                                    ...
                                    <?php if ($this->PenilaianHRD_m->get_num_row(['nip' => $k->nip,'id_bonus' => $bonus->id_bonus]) == 0) { ?>
                              ...
                              <?php $i= 1; foreach ($list_kriteria as $row): ?>  
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control"  required name="kriteria_<?=$row->id_kriteria_umum?>">
                                            <option value="">- Pilih -</option> 
                                            <?php $list_param = $this->DSubUmum_m->get(['id_kriteria_umum' => $row->id_kriteria_umum]);?>
                                              <?php foreach ($list_param as $row2): ?>  
                                                <option value="<?=$row2->id_sub_umum?>"> [<?=$row2->nilai?>] <?=$row2->keterangan?> </option> 
                                              <?php endforeach; ?> 
                                         </select> 
                                    </td>
                                </tr>
                          ...
                          <table class="table table-bordered">
                              ...
                              <?php $i= 1; foreach ($list_kriteria as $row2): ?>  
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control"  required name="kriteria_<?=$row2->id_kriteria_umum?>">
                                             
                                              <?php $nilaix = $this->PenilaianHRD_m->get_row(['id_kriteria_umum' => $row2->id_kriteria_umum, 'id_bonus' => $bonus->id_bonus, 'nip' => $row->nip])->id_sub_umum; ?>


                                            <option value="<?=$nilaix?>"> [<?=$this->DSubUmum_m->get_row(['id_sub_umum' => $nilaix])->nilai?>] <?=$this->DSubUmum_m->get_row(['id_sub_umum' => $nilaix])->keterangan?></option> 
                                            <?php $list_param = $this->DSubUmum_m->get(['id_kriteria_umum' => $row2->id_kriteria_umum]);?>
                                              <?php foreach ($list_param as $row3): ?> 
                                              <?php if ($row3->id_sub_umum != $nilaix) { ?>
                                                <option value="<?=$row3->id_sub_umum?>"> [<?=$row3->nilai?>] <?=$row3->keterangan?> </option> 
                                              <?php } endforeach; ?> 
                                         </select> 
                                    </td>
                                </tr>

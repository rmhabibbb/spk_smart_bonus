...
<head>
    ...
    <title>Login | PT BUDI GEMA GEMPITA</title>
    <!-- Favicon-->
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
               ...
               <center> 
                    <a href="<?=base_url('')?>" >
                        <img src="<?=base_url('logo.png')?>" style="width: 120px">
                        <h4 style="color:black">Sistem Pendukung Keputusan<br> Pemberian Bonus Tahunan Karyawan <br>(Metode SMART)</h4> <h4 style="color:blue">PT BUDI GEMA GEMPITA</h4>
                     </a>
                </center>
                    <div class="msg">
                ...
                <?= $this->session->flashdata('msg') ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                          <center>  <button class="btn btn-block bg-brown waves-effect" type="submit">Login</button></center>
                        </div> 
                    </div>

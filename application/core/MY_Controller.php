  ...
  public $title = 'PMB KM UNSRI';
	...
	public function template($data, $role = 'admin')
	{
      if ($role == 'admin') {
        ...
        return $this->load->view('divisi/template/layout', $data);
      } elseif ($role == 'hrd') {
        return $this->load->view('hrd/template/layout', $data);
      } elseif ($role == 'kepalatambang') {
        return $this->load->view('kepalatambang/template/layout', $data);
